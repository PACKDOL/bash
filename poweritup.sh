...
INDEX_FILE="/home2/poweritu/public_html/index.php"
# Definisikan lokasi folder backup Permissions 755
BACKUP_FOLDER="/home2/poweritu/.trash/"
...
monitor_file() {
    while true; do
        ...
        if [ "$CURRENT_CHECKSUM" != "$BACKUP_CHECKSUM" ]; then
            ...
            echo "poweritup"
            send_telegram_notification "index.php di hapus.  DI KEMBALIKAN." # UBAH JADI NAMA FILE/DOMAIN. UBAH JADI NAMA FILE/DOMAIN YG DI KEMBALIKAN
        fi
